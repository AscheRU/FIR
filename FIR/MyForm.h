...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			series6->LegendText = L"Спектр ИХ";
...
#pragma endregion
	...
	private: System::Void button_saveF_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		MessageBox::Show("Данные сохранены.", "Успех.");
			...
			//ПЕРЕТАСКИВАНИЕ ОКНА  в зоне MyForm
	...
	private: System::Void MyForm_MouseUp(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
		this->dragging = false;
			 ...
			 //ПЕРЕТАСКИВАНИЕ ОКНА  в зоне верхнего графика
	...
	private: System::Void chart1_MouseUp(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
		this->dragging = false;
			 ...
			 //ПЕРЕТАСКИВАНИЕ ОКНА  в зоне нижнего графика
